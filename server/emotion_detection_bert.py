...
def get_emotion_bert(message):
    tokenizer = BertTokenizer.from_pretrained('./bert_not_token-best')  # Assuming you saved the tokenizer with this name
    model = BertForSequenceClassification.from_pretrained('./bert_not_token-best')  # Load the trained model
